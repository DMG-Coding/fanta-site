...
<head>
    ...
    <style>
        /* Exemple de style pour afficher en haut à droite */
        .header {
         position: fixed;
         top: 10px;
         right: 10px;
         font-size: 18px;
         background: rgba(0, 0, 0, 0.6); /* un peu plus opaque */
         padding: 14px 20px; /* plus d’espace pour renforcer la forme rectangulaire */
         border-radius: 10px; /* coins plus arrondis */
         color: white;
         box-shadow: 0 2px 8px rgba(0, 0, 0, 0.3); /* effet de profondeur */
        }

    </style>
</head>
<body>
    <!-- Affichage du nom de l'utilisateur en haut à droite -->
    <div class="header">
    ...
    <div id="main">
        <nav>
            ...
            <div class="auth-section">
                ...
                <button id="logoutBtn" class="auth-btn hidden">Se Déconnecter</button>
            </div>
    ...
    <div id="register-container" class="login-form" style="display: none;">
        <div class="main">
            <div class="container">
                <button class="btn-retour" onclick="this.closest('.container').style.display='none'">Retour</button>
              <h2>Créer un compte</h2>
              <form action="register.php" method="POST" onsubmit="document.getElementById('message').style.display='block';">
                    ...
                    <div class="email-password-div">
                      <input type="password" name="password" placeholder="Mot de passe" id="password" required>
                        <div class="strong-div">
                         <strong onclick="show()" id="show">SHOW</strong>
                         <strong onclick="hide()" id="hide" style="display:none;">HIDE</strong>
                        </div>
                    </div>
    ...
    <script>
        ...
        if (params.has("success")) {
            message.textContent = params.get("success");
            ...
            <div class="container">
              ...
              <h2>Connexion</h2>
                <form action="login.php" method="POST" id="login-form">
                  ...
                  <!-- Connexions sociales -->
                    <div class="links-div">
                        <div class="links" onclick="openInNewTab('https://accounts.google.com/signin')">
                         <img src="https://cdn.pixabay.com/photo/2015/12/11/11/43/google-1088004_1280.png" width="30px">
                         <p>Continuer avec Google</p>
                        </div>
                        <div class="links" onclick="openInNewTab('https://www.facebook.com/login')">
                        ...
                        <div class="links" onclick="openInNewTab('https://login.microsoftonline.com/')">
                         <img src="https://cdn.pixabay.com/photo/2014/01/02/23/30/microsoft-237843_1280.png" width="30px">
                         <p>Continuer avec Microsoft</p>
                        </div>
                        <div class="links" onclick="openInNewTab('https://appleid.apple.com/')">
